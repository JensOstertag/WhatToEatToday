  ...
  render() {
    return (
      <section>
        ...
        <Selector>
          <Selectable name="" title="Complete Dinner" description={["Decide over a complete dinner with garnish and a main ingredient"]} image="food-types-complete.svg" linkTo="/eating-habits" selectKey="food-type" selectValue="complete" />
          ...
          <Selectable name="" title="Main Ingredient" description={["Decide over what to cook as a main ingredient"]} image="food-types-main.svg" linkTo="/eating-habits" selectKey="food-type" selectValue="main" />
